...
class Model:
    ...
    def _decode(self,
        ...
        encoder_out, _, _ = self.model.forward_encoder_chunk(feats, 0, -1, cat_embs = cat_embs)
    ...
    def transcribe(self, audio_file: str, tokens_info: bool = False, cat_embs = None) -> dict:
        return self._decode(audio_file, tokens_info, cat_embs = cat_embs)
...
def load_model(model_path: str = None,
    ...
    return Model(model_path, units_path, gpu, beam, context_path, context_score)