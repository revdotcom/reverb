    ...
    if (batch_idx + 1) % log_interval == 0:
        ...
        if rank == 0 and wandb.run is not None:
            ...
            wandb_log = { nick + 'losses': loss_dict,
                          nick + 'step': step,
                          nick + 'batch_idx': batch_idx,
                          nick + 'epoch': epoch,
                          nick + 'lr': lr,
                          nick + 'grad_norm': info_dict.get('grad_norm', -1.0),
